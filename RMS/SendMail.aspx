<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SendMail.aspx.cs" Inherits="RMS.Send_Mail" %>
        ...
        <tr>
            ...
            <td class="style6" style="vertical-align: top">
                ...
                <asp:Panel ID="Panel5" runat="server" Height="214px" Style="text-align: center"
                    ...
                    <table class="style44">
                        <tr>
                            <td bgcolor="#999966" class="style81" colspan="2">Email Account Setup</td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#999966" class="style82">Host:</td>
                            <td class="style61">
                                <asp:TextBox ID="txtHost" runat="server" Width="290px">smtp.gmail.com</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#999966" class="style82">Port:</td>
                            <td class="style61">
                                <asp:TextBox ID="txtPort" runat="server" Width="290px">587</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#999966" class="style82">Email:</td>
                            <td class="style61">
                                <asp:TextBox ID="txtCred1" runat="server" Width="290px">info@gmail.com</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#999966" class="style82">Password:
                            </td>
                            <td class="style61">
                        ...
                        <tr>
                            <td align="left" bgcolor="#999966" class="style82">Enable SSL:</td>
                            <td class="style61">
                                <asp:TextBox ID="txtSSL" runat="server" Height="23px" Width="290px">true</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#999966" class="style81" colspan="2">&nbsp;</td>
                        </tr>
                    </table>
                    <br />
                </asp:Panel>

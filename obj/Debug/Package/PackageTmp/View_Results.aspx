<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View_Results.aspx.cs" Inherits="RMS.View_Results" %>
            ...
            <asp:Panel ID="Panel3" runat="server" Height="722px" style="margin-left: 0px" 
                ...
                <asp:Panel ID="Panel4" runat="server" Visible="False">
                    <table align="center" bgcolor="#E4E4E4" class="style2" 
                        ...
                        <tr>
                            <td align="left" class="style195" style="font-size: small; ">
                                &nbsp;</td>
                            <td align="left" class="style196" style="font-size: small; ">
                                Course Code</td>
                            <td align="left" class="style202" style="font-size: small; ">
                                Score</td>
                            <td align="left" style="font-size: small; " class="style192">
                                Grade</td>
                            <td align="left" class="style200" style="font-size: small; ">
                                Course Code</td>
                            <td align="left" class="style190" style="font-size: small; ">
                                Score</td>
                            <td align="left" class="bold" style="font-size: small; ">
                                Grade</td>
                        </tr>
                        <tr>
                            <td align="left" class="style189" style="font-size: small; ">
                                &nbsp;</td>
